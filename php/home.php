...
<body>
    ...
    <div class="hero block">
        ...
        <div class="tombol">
            <div class="subs-container">
                <a href="subs.php" class="subs">Berlangganan</a>
            </div>
    ...
    <div id="alasan" class="alasan-container d-flex flex-lg-row flex-md-column justify-content-evenly align-items-center">
    ...
    <div id="kontak" class="kontak-container">
    ...
    <div class="footer-container">
        <div class="menu-container d-flex justify-content-evenly flex-lg-row flex-md-column text-lg-start text-md-center">
            <img class="mb-md-5 align-self-center" src="../assets/logo.png" alt="" width="150" height="90">
            <div class="touch col-lg-2 mb-md-5">
                <h5>Hubungi Kami</h5>
                <p>Jl. M.H. Thamrin No.1, Kb. Melati, Kec. Menteng, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10310</p>
                <p>Call: +62 813 5610 8992</p>
            </div>
            <div class="menu mb-md-5">
                <h5>Menu</h5>
